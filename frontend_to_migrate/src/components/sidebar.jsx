...
export const Sidebar = () => {
    ...
    const Menus = [
        ...
        { title: "Notificacions", Image: notificacion, height: "40", width: "30", style: "stroke-white group-hover:stroke-sky-500 duration-700", goTo: "/notificaciones", visible: "true" },
    ...
    return (
        <div className="flex sticky top-0 h-screen bg-slate-800">
            <div className="w-1/5 p-4">
                <div className={` ${open ? "w-72" : "w-20"} bg-dark-purple h-screen p-5 pt-8 relative duration-1000`}>
                    <img
                        src={flecha}
                        width="50px"
                        height="50px"
                    ...
                    <div className="flex gap-x-4 items-center">
                        <img src={ubL} alt="UB Logo" />
                        <h1 className={`text-white origin-left font-medium text-xl duration-1000 ${!open && "scale-0"}`}>
                            Corrector UB
                        </h1>
                    </div>
                    <ul className="pt-6">
                        {Menus.map((Menu, index) => (
                            ...
                            >
                                <div className="relative">  
                                    ...
                                    {Menu.title === "Notificacions" && newNotification && (
